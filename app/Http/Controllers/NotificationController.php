...
class NotificationController extends Controller
{
    ...
    {
        $this->app_id = getenv('PUSHER_APP_ID');
        $this->app_key = getenv('PUSHER_APP_KEY');
    ...
    *     description="Get paginated list of Notifications with search, filter, and sorting options.",
    *     security={{"BearerAuth":{}}},
    *
    ...
    */
    ...
    {
        try {
            // For Publish Event on Single Channel
            $channels = 'my-channel';
            $event = 'my-event'; 
            $data = ['message' => 'hello world'];
            
            // For Publish Event on Multiple Channels
            // $channels = ['my-channel-1','my-channel-2','my-channel-3'];
            // $event = 'my-event'; 
            // $data = ['message' => 'hello world'];
